...
function enhancedCombineTypes(dbTypesPath, edgeFunctionTypesPath, outputPath, version) {
  console.log('🚀 Enhanced Type Combination...');
  ...
  for (const headerPath of headerFiles) {
    if (fs.existsSync(headerPath)) {
      ...
      if (enumMatches) {
        ...
        console.log('✓ Read database enums from', headerPath);
        break;
      }
    }
  }
  ...
  const combinedTypes = `
// ignore_for_file: non_constant_identifier_names, camel_case_types, file_names, unnecessary_null_comparison, prefer_null_aware_operators, duplicate_ignore, unnecessary_question_mark
...
`;
  ...
  console.log('✅ Enhanced combined types file generated');
  ...
  console.log(`📊 Database Views: ${dbViews}`);
  console.log(`🏷️  Database Enums: ${dbEnums}`);
  console.log(`⚡ Edge Function Types: ${edgeFuncs}`);
  console.log(`📦 Total Types: ${dbModels + dbViews + edgeFuncs}`);
...
if (require.main === module) {
  ...
  try {
    ...
    console.log('✅ Enhanced type combination completed successfully');
  } catch (error) {
