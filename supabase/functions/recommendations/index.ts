  ...
  try {
    ...
    const mockRecommendations = [
      ...
      },
      {
        ...
        recommendation_text: "Deep breathing can help reduce stress and improve focus.",
        action: "Practice 4-7-8 breathing for 5 minutes",
        why: "Controlled breathing activates your parasympathetic nervous system",
        recommendation_type: "action",
        importance: 3,
        relevance: 0.75,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        recommendation_text: "The Mindfulness category has techniques that might help with your current stress levels.",
